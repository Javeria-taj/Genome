      ...
      <div className="panel-grid">
        ...
        <div className="panel panel-full" style={{ height: 240 }}>
          ...
          <div style={{ height: "calc(100% - 33px)", position: "relative" }}>
            {typeof window !== "undefined" && <WorldMap />}
          </div>
        </div>
        ...
        <div className="panel panel-full">
          ...
          <div className="pbody">
            {!selectedCoords ? (
              ...
              <div style={{ border: "1px solid var(--red)", padding: "6px 10px", fontSize: 9, color: "var(--red)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <>
                ...
                <div style={{ display: "flex", gap: 14, margin: "8px 0" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 8.5, color: "var(--dim)" }}>
                    <div style={{ width: 14, height: 1, background: "var(--red)", opacity: .4 }} />Trend line
                  </div>
                </div>
                {warmest && wettest && trend && (
                  <div style={{ fontSize: 8.5, color: "var(--dim)", borderTop: "var(--bh)", paddingTop: 6 }}>
                    ...
                    &nbsp;·&nbsp; Trend: <b style={{ color: "var(--red)" }}>+{trend}°C</b>
                  </div>
                )}
                <div className="stat-row" style={{ marginTop: 12 }}>
                  <div className="sc"><span className="sv">{warmest?.avgTemp.toFixed(1)}°</span><span className="sl">Peak Avg</span></div>
                  <div className="sc"><span className="sv" style={{ color: "var(--red)" }}>+{trend}°</span><span className="sl">Δ 40yr</span></div>
